...
def make_prediction(processed_img):
    ...
    masks = (normalized_preds > 0.8).float()
    return masks
...
st.write("This app removes the background from an image using a pre-trained deep learning model.")
upload = st.file_uploader(label="Upload Image Here:", type=["jpg", "png", "jpeg"])
